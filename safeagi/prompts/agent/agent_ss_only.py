...
from safeagi.prompts.agent.shared import *
from safeagi.prompts.globals import *
from safeagi.prompts.principles import TOOL_CALL_SAFETY_SECURITY_REQS
...
if __name__ == "__main__":
    ...
    system_prompt, example_prompt = format_multiple_prompts(
        [AGENT_SS_ONLY_SYSTEM_INFO, AGENT_SS_ONLY_PROMPT,],
        inputs,
