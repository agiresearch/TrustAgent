...
from safeagi.prompts.generator.case_gen.shared import *
from safeagi.prompts.globals import BRACKET_DEF
...
if __name__ == "__main__":
    ...
    system_prompt, example_prompt = format_multiple_prompts(
        [STANDARD_CASE_GEN_SYSTEM_MESSAGE, STANDARD_CASE_GEN_PROMPT,],
        inputs,
