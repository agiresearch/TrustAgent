...
SAFETY_CHECK_DEF = NamedVariable(
    refname="safety_checker",
    name="Safety checker",
    content="The safety checker who evaluates whether planned actions are safe against given safety regulations.",
)

ALL_DEFS = Collection(USER_DEF, AGENT_DEF, SIMULATOR_DEF, SAFETY_CHECK_DEF)
    ...
    Collection(
        NamedVariable(
            ...
            content=Sequential(
                ...
                Collection(
                    NamedVariable(
                        refname="user_name", name="Name", content="John Doe",
                    ),
                    NamedVariable(
                        refname="user_email",
                        name="Email",
