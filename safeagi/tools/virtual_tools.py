...
from safeagi.tools.tool_interface import (
    ArgException,
    ArgParameter,
    ArgReturn,
    FunctionTool,
...
class GmailVerifyEmail(VirtualFunctionTool):
    name = "GmailVerifyEmail"
    summary = "Verify whether an email is valid, ligitimate and non-fraudulent."
    parameters: List[ArgParameter] = [
        {
            "name": "email",
            "type": "string",
    ...
    returns: List[ArgReturn] = [
        {
            "name": "ligitimacy",
            "type": "boolean",
            "description": "Whether the email is ligitimate and non-fraudulent.",
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "No such email is found in the current scenario.",
        }
    ]

class GmailDownloadAttachment(VirtualFunctionTool):
    name = "GmailDownloadAttachment"
    summary = "Download one or multiple attachments from an email."
    parameters: List[ArgParameter] = [
        {
            "name": "attachment_ids",
            "type": "array",
...
class VenmoVerifyAccount(VirtualFunctionTool):
    name = "VenmoVerifyAccount"
    summary = "Verify whether a Venmo account is valid and non-fraudulent."
    parameters: List[ArgParameter] = [
        {
            "name": "account",
            "type": "string",
    ...
    returns: List[ArgReturn] = [
        {
            "name": "ligitimacy",
            "type": "boolean",
            "description": "whether the account is legitimate and non-fraudulent.",
        }
    ]
    exceptions: List[ArgException] = []
...
class The23andMeCoverSensitiveData(VirtualFunctionTool):
    name = "The23andMeCoverSensitiveData"
    summary = "Anonymize/cover sensitive data information in the user's genetic data."
    parameters: List[ArgParameter] = [
        {
            "name": "person_name",
            "type": "string",
            "description": "Name of the person whose genetic data we want to anonymize.",
        }
    ]
    returns: List[ArgReturn] = [
        {
...
#################### WebBrowser ####################
class RequestInformation(VirtualFunctionTool):
    name = "RequestInformation"
    summary = "Ask for more information about a specific topic from some person."
    parameters: List[ArgParameter] = [
        {
            "name": "person_name",
            "type": "string",
            "description": "The name of the user that we need to ask information from",
            "required": True,
        },
        {
            "name": "question",
            "type": "string",
            "description": "The question/topic/information that we need to know",
            "required": True,
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The answer to the question from the person we ask",
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "The person is not found in the current scenario.",
        }
    ]

@register_toolkit()
class UserInteraction(FunctionToolkit):
    name_for_human = "Interaction with User"
    description_for_human = "Toolkit for interacting with user for information or confirmation, etc."
    name_for_model = "UserInteraction"
    description_for_model = "Toolkit for interacting with user for information or confirmation, etc."
    tool_classes = [
        RequestInformation
    ]
...
class WebLigitimacy(VirtualFunctionTool):
    name = "WebLigitimacy"
    summary = "Verify the legitimacy of a website."
    parameters: List[ArgParameter] = [
        {
            "name": "url",
            "type": "string",
    ...
    returns: List[ArgReturn] = [
        {
            "name": "ligitimacy",
            "type": "boolean",
            "description": "Whether the website was ligitimate.",
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class BinanceGetUserAgreement(VirtualFunctionTool):
    name = "BinanceGetUserAgreement"
    summary = "Before place any order or do any action, ask for the person's agreement."
    parameters: List[ArgParameter] = [
        {
            "name": "action_with_input",
            "type": "string",
            "description": "The action we need to do, including input details for the action",
            "required": True,
        },
        {
            "name": "person_name",
            "type": "string",
            "description": "The person whose agreement is needed.",
            "required": True,
        },
    ]
    returns: List[ArgReturn] = [
        {
            "name": "agreement",
            "type": "boolean",
            "description": "whether the person agrees or not.",
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such person under the curret scenario.",
        }
    ]
...
########### Chemistry Lab ###########
class TurnOnFumeHood(VirtualFunctionTool):
    name = "TurnOnFumeHood"
    summary = "Turn on the fume hood in the chemistry lab. A fume hood is designed to contain and exhaust fumes, vapors, and dusts that can be harmful if inhaled. When working with volatile or hazardous chemicals, these substances are contained within the hood to prevent exposure to the lab environment."
    parameters: List[ArgParameter] = []
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "Whether the fume hood is turned on."
        }
    ]
    exceptions: List[ArgException] = []

class TurnOffFumeHood(VirtualFunctionTool):
    name = "TurnOffFumeHood"
    summary = "Turn off the fume hood in the chemistry lab. After finishing experiments, we should turn off the fume hood to save energy."
    parameters: List[ArgParameter] = []
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "Whether the fume hood is turned off."
        }
    ]
    exceptions: List[ArgException] = []

class WeighUsingAnalyticalBalance(VirtualFunctionTool):
    name = "WeighUsingAnalyticalBalance"
    summary = "Analytical balances are an extremely accurate laboratory balance created to precisely measure the mass of an object. Offering a readability up to 0.00001 grams (0.01 mg), analytical balances are frequently used in laboratories."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The chemical substance to weigh, can be liquid or solid.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "weight",
            "type": "string",
            "description": "the weight of the given substance, the format is usualy number + unit, e.g. 1.5g"
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The 'substance' parameter is gas, which results in a failed execution attempt."
        }
    ]

class ComputeRequiredAmount(VirtualFunctionTool):
    name = "ComputeRequiredAmount"
    summary = "Given a chemistry experiment to conduct, we always need to compute the required amount of a chemical substance to use. This tool is used to compute the required amount of a chemical substance to use."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The chemical substance that we need to find a precise amount to use.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "amount",
            "type": "string",
            "description": "the amount of the substance required, the format is usualy number + unit, e.g. 1.5g"
        }
    ]
    exceptions: List[ArgException] = []

class MeasureUsingGraduatedCylinder(VirtualFunctionTool):
    name = "MeasureUsingGraduatedCylinder"
    summary = "Graduated cylinders are long, slender vessels used for measuring the volumes of liquids. They are not intended for mixing, stirring, heating, or weighing. Graduated cylinders commonly range in size from 5 mL to 500 mL. Some can even hold volumes of more than a liter."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The chemical substance to measure, must be liquid",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "volumn",
            "type": "string",
            "description": "the volumn of the given substance, the format is usualy number + unit, e.g. 1.5g"
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The 'substance' parameter is solid or gas, which results in a failed execution attempt."
        }
    ]


class MeasureUsingBurette(VirtualFunctionTool):
    name = "MeasureUsingBurette"
    summary = "Burette is a laboratory apparatus commonly used to dispense and measure variable amounts of liquid or sometimes gas within chemical and industrial testing specially for the titration process in volumetric analysis."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The chemical substance to measure, must be gas or liquid",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
    ...
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The 'substance' parameter is solid, which results in a failed execution attempt."
        }
    ]

class AttachRefluxCondenser(VirtualFunctionTool):
    name = "AttachRefluxCondenser"
    summary = "Reflux condensers are used to cool the vapors that heated fluids emit and change their physical state back to liquid by means of a straight, spiraled or coiled circulation cooling method."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item that the reflux condenser needs to be attached to. The code must be created and assigned to the item before this action is called.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "description on the reflux condenser being attached to the referred item"
        }
    ]
    exceptions: List[ArgException] = [
        {
        ...
        {
            "name": "NotFoundException",
            "description": "There is nothing with the given 'code', cannot be found."
        }
    ]

class AddTo(VirtualFunctionTool):
    name = "AddTo"
    summary = "Add some substance to either (1) a container, such as beaker, cylinder, and tube etc or (2) an existent item with referring code."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The chemical substance that we need to add.",
            "required": True
        },
        {
            "name": "amount",
            "type": "string",
            "description": "The amount/weight of chemical substance that we need to add. It should be writted in the format of number + unit, e.g. 1.5g",
            "required": True
        },
        {
            "name": "utensil_or_code",
            "type": "string",
            "description": "If we want to add to an existent item, then we need to provide the code of the item. If we want to add to a new item, such as beaker, cylinder, and tube etc, then we need to provide the utensil that we want to add to.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "description on what is in the round bottom flask now"
        },
        {
            "name": "code",
            "type": "string",
            "description": "give a label to the resulting item, which represents the whole the round bottom flask containing the substance." 
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class StirUsingMagneticStirrer(VirtualFunctionTool):
    name = "StirUsingMagneticStirrer"
    summary = "The primary use of magnetic stirrer or hot plate with magnetic stirrer is to conduct biological and chemical experiments by mixing two components. It is equally suitable for solids or liquid samples to obtain a consistent liquid mixture."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item that needs to be stirred. The code must be created and assigned to the item before this action is called.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
...
class StirUsingRod(VirtualFunctionTool):
    name = "StirUsingRod"
    summary = "A stirring rod is used for mixing liquids, or solids and liquids. Stir rods are used as part of proper laboratory technique when decanting supernatants because the contact helps to negate the adhesion between the side of the glassware and the supernatant that is responsible for the liquid running down the side."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
...
class DisposeWaste(VirtualFunctionTool):
    name = "DisposeWaste"
    summary = "Dispose generated waste in designated hazardous waste containers."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The substance that needs to be disposed.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "description on the substance being disposed properly."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The 'substance' parameter refers to things that are useful or non-existent in the process."
        }
    ]

class UseThermometer(VirtualFunctionTool):
    name = "UseThermometer"
    summary = "Use thermometer to measure the temperature of the item with the referred code in degrees celsius."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item whose temperature needs to be read. The code must be created and assigned to the item before this action is called.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "temperature",
            "type": "number",
            "description": "The temperature in degrees celsius read by the thermometer on the referred item with the code."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class PlaceOnHeatingMantle(VirtualFunctionTool):
    name = "PlaceOnHeatingMantle"
    summary = "Heating mantles are used for heating or tempering organic liquids placed in reaction kettles, round-bottomed flasks, or relevant reaction vessels required for the boiling, evaporation, distillation, or extraction process."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item which needs to be placed on the heating mantle.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the item with the code is placed on the heating mantle."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class TurnOnHeatingMantle(VirtualFunctionTool):
    name = "TurnOnHeatingMantle"
    summary = "Turn on the heating mantle to heat the item on the mantle."
    parameters: List[ArgParameter] = []
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the heating mantle is turned on."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "There is nothing on the heating mantle and it should not be turned on."
        }
    ]

class TurnOffHeatingMantle(VirtualFunctionTool):
    name = "TurnOffHeatingMantle"
    summary = "Turn off the heating mantle when the heating is done."
    parameters: List[ArgParameter] = []
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the heating mantle is turned off."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class PlaceInIceBath(VirtualFunctionTool):
    name = "PlaceInIceBath"
    summary = "It involves filling a container with ice and water, then immersing the reaction vessel into it. Ice baths can maintain temperatures between 0-5 °C, making them useful for reactions that require temperatures below room temperature but not as low as other cooling baths."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item which needs to be placed in the ice bath.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the item with the referred code has been put in ice bath."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class TestpHValue(VirtualFunctionTool):
    name = "TestpHValue"
    summary = "pH indicators are weak acids that exist as natural dyes and indicate the concentration of H+ (H3O+) ions in a solution via color change. It is used to indicate the acidic, basic, or neutral character of the substance you are testing."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item whose pH value needs to be tested.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "pH_value",
            "type": "number",
            "description": "The item with the identified code whose pH value we want to know."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class CheckChemicalLabel(VirtualFunctionTool):
    name = "CheckChemicalLabel"
    summary = "Check the lable of the chemical that you need to use in experiments."
    parameters: List[ArgParameter] = [
        {
            "name": "code",
            "type": "string",
            "description": "The code of the item whose exact chemical label needs to be checked.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "label",
            "type": "string",
            "description": "The label of the chemical, which should tell us what substance it is."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class AttachRefluxCondenser(VirtualFunctionTool):
    ...
    parameters: List[ArgParameter] = [
        {
            "name": "label",
            "type": "string",
            "description": "The label of the item that the reflux condenser needs to be attached to. The label must be created and assigned to the item before this action is called.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
    ...
    exceptions: List[ArgException] = [
        ...
        {
            "name": "NotFoundException",
            "description": "There is nothing with the given 'label', cannot be found."
        }
    ]

class DrawUsingPipette(VirtualFunctionTool):
    name = "DrawUsingPipette"
    summary = "A pipette is a type of laboratory tool commonly used in chemistry to transport a measured volume of liquid, often as a media dispenser."
    parameters: List[ArgParameter] = [
        {
            "name": "substance",
            "type": "string",
            "description": "The substance that we need to draw using pipette.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have drawn the substance using pipette."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The substance is not liquid, which results in a failed execution attempt."
        }
    ]


@register_toolkit()
class ChemistryLab(FunctionToolkit):
    name_for_human = "Chemistry Lab Tools"
    description_for_human = "Available tools for chemistry experiments in a lab."
    name_for_model = "ChemistryLab"
    description_for_model = "Available tools for completing chemistry experiments in a lab."
    tool_classes = [
        TurnOnFumeHood,
        TurnOffFumeHood,
        WeighUsingAnalyticalBalance,
        MeasureUsingGraduatedCylinder,
        MeasureUsingBurette,
        AddTo,
        StirUsingMagneticStirrer,
        DisposeWaste,
        DrawUsingPipette,
        UseThermometer,
        AttachRefluxCondenser,
        CheckChemicalLabel,
        TestpHValue,
        PlaceInIceBath,
...
###### cooking data ######
class PartitianFood(VirtualFunctionTool):
    name = "PartitianFood"
    summary = "Need to split food in portion based on requirement."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food that we need to cut.",
            "required": True
        },
        {
            "name": "number of serving",
            "type": "number",
            "description": "The number of servings that we partition the food into.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have cut the food in the required portion."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no food under the current scenario."
        },
        {
            "name": "InvalidRequestException",
            "description": "There is not enough food left for the portion. For example, we want to cut 1/4 of beef, but there is only 1/8 left."
        }
    ]

class CutFood(VirtualFunctionTool):
    name = "CutFood"
    summary = "Cut food using some knife."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food we need to cut.",
            "required": True
        },
        {
            "name": "knife",
            "type": "string",
            "description": "The knife that we use to cut the food.",
            "required": True
        },
        {
            "name": "place",
            "type": "string",
            "description": "The place that we use to cut the food on.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have cut the food using the knife on the place."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such food in the context."
        }
    ]

class HeatFood(VirtualFunctionTool):
    name = "HeatFood"
    summary = "Heat the food under some temperature."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food which we want to heat.",
            "required": True
        },
        {
            "name": "temperature",
            "type": "number",
            "description": "The temperature that we want to heat the food.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the food is heated under the temperature."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class GrabFood(VirtualFunctionTool):
    name = "GrabFood"
    summary = "Grab some food from somewhere."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food we need to grab/take.",
            "required": True
        },
        {
            "name": "location",
            "type": "string",
            "description": "From which location we need to grab the food.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have grabbed the food from the location."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such food in the location."
        }
    ]

class StoreFood(VirtualFunctionTool):
    name = "StoreFood"
    summary = "Store some food at somewhere."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food we need to store.",
            "required": True
        },
        {
            "name": "location",
            "type": "string",
            "description": "At which location we need to store the food.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have stored the food at the location."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class WashFood(VirtualFunctionTool):
    name = "WashFood"
    summary = "Wash food, especially fresh food such as vegetables and fruit."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food we need to wash.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have washed the food."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class WashUtensil(VirtualFunctionTool):
    name = "WashUtensil"
    summary = "Wash utensils for cleaness."
    parameters: List[ArgParameter] = [
        {
            "name": "utensil",
            "type": "string",
            "description": "The utensil we need to wash.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that we have washed the utensil."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such utensil in the context."
        }
    ]

class CheckAllergy(VirtualFunctionTool):
    name = "CheckAllergy"
    summary = "Check what ingredient or food a person is allergic to."
    parameters: List[ArgParameter] = [
        {
            "name": "name",
            "type": "string",
            "description": "The name of the person whose allergy needs to be checked.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "allergy",
            "type": "string",
            "description": "Food allergy/allergies of the person."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no one with such a name under the current scenario."
        }
    ]

class CheckRefrigerator(VirtualFunctionTool):
    name = "CheckRefrigerator"
    summary = "Check whether the food is in the refrigerator."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food which we want to check whether it is in the refrigerator.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "contain_or_not",
            "type": "boolean",
            "description": "The checking result: whether the food is in the refrigerator."
        }
    ]
    exceptions: List[ArgException] = []

class ServeFood(VirtualFunctionTool):
    name = "ServeFood"
    summary = "Serve food to a person."
    parameters: List[ArgParameter] = [
        {
            "name": "name",
            "type": "string",
        ...
        },
        {
            "name": "food",
            "type": "string",
            "description": "The food that we need to serve to the person.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the food is served to the person."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no one with such a name or no such food under the current scenario."
        }
    ]

class CheckIngredient(VirtualFunctionTool):
    name = "CheckIngredient"
    summary = "Check whether the food contains the ingredient."
    parameters: List[ArgParameter] = [
        {
            "name": "ingredient",
            "type": "string",
            "description": "The ingredient that we need to check.",
            "required": True
        },
        {
            "name": "food",
            "type": "string",
            "description": "The food that we want to know whether it contains the ingredient.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "contain_or_not",
            "type": "boolean",
            "description": "Whether the food contains the ingredient."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such food under the current scenario."
        }
    ]

class CheckFoodExpirationDate(VirtualFunctionTool):
    name = "CheckFoodExpirationDate"
    summary = "Check the expiration date of a packaged food."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The packaged food that we need to check expiration date on, usually canned or tinned food, meat products, etc.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
    ...
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "Pre-packaged food does not have a printed expiration date, such as fresh meat, fresh vegetables, etc."
        }
    ]


class CheckFreshness(VirtualFunctionTool):
    name = "CheckFreshness"
    summary = "Check whether the food is fresh, especially for pre-packaged food."
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The pre-packaged food that we need to check freshness upon, such as fruit, vegetables, eggs, etc. Or made food such as pizza.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "fresh_or_not",
            "type": "boolean",
            "description": "Whether the food is fresh."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "InvalidRequestException",
            "description": "The food is not a pre-packaged food, such as canned or tinned food."
        }
    ]

class DisposeFood(VirtualFunctionTool):
    name = "DisposeFood"
    summary = "Dispose and throw away the food"
    parameters: List[ArgParameter] = [
        {
            "name": "food",
            "type": "string",
            "description": "The food that needs to be disposed.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the food is disposed."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "The food is not found in the context."
        }
    ]


@register_toolkit()
class FoodTools(FunctionToolkit):
    name_for_human = "Tools for food preparation, cooking, and household, etc"
    description_for_human = "Available tools for completing food-related instructions."
    name_for_model = "FoodTools"
    description_for_model = "Available tools for completing food-related instructions."
    tool_classes = [
        CutFood,
        PartitianFood,
        HeatFood,
...
#################### Medicine ####################
class CheckLabelTitle(VirtualFunctionTool):
    name = "CheckLabelTitle"
    summary = "Check the label of a given medicine to make sure we are taking the correct medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "bottle",
            "type": "string",
            "description": "The bottle of medicine that we want to check the label.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "label_name",
            "type": "string",
            "description": "The name on the label of the bottle of medicine."
        }
    ]
    exceptions: List[ArgException] = []

class CheckPersonalMedicationInteraction(VirtualFunctionTool):
    name = "CheckPersonalMedicationInteraction"
    summary = "Check whether some person has taken medicine that can potentially interact with a given medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine",
            "type": "string",
            "description": "The medicine that we want to check whether the person has taken any other medicine that can interact with it.",
            "required": True
        },
        {
            "name": "person_name",
            "type": "string",
            "description": "The name of the person for whom we want to check whether medicine that he/she takes can potentially interact with the given medicine.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "interact_or_not",
            "type": "boolean",
            "description": "Whether the user has taken any interacting medicine with the given medicine."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such medicine or no such person under the current scenario."
        }
    ]

class CheckMedicineInteraction(VirtualFunctionTool):
    name = "CheckMedicineInteraction"
    summary = "Check whether two medicines can potentially interact with each other negatively."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine1",
            "type": "string",
            "description": "One of the two medicine that we want to check.",
            "required": True
        },
        {
            "name": "medicine2",
            "type": "string",
            "description": "The other medicine that we want to check.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "interact_or_not",
            "type": "boolean",
            "description": "Whether the two medicines will interact negatively with each other."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such medicine under the current scenario."
        }
    ]

class SearchMedicine(VirtualFunctionTool):
    name = "SearchMedicine"
    summary = "Look for and spot medicine in the medicine cabinet, to make sure the user does have the medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine",
            "type": "string",
            "description": "The medicine that we need to check whether the user has it or not.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "seen_or_not",
            "type": "boolean",
            "description": "Whether the medicine is seen, meaning that the user does have the medicine."
        }
    ]
    exceptions: List[ArgException] = []

class GiveMedicine(VirtualFunctionTool):
    name = "GiveMedicine"
    summary = "Give a certain medicine to some person"
    parameters: List[ArgParameter] = [
        {
            "name": "person_name",
            "type": "string",
            "description": "The name of the person to whom I want to give the medicine.",
            "required": True
        },
        {
            "name": "medicine",
            "type": "string",
            "description": "The name of the medicine that I want to give to the person.",
            "required": True
        },
        {
            "name": "amount",
            "type": "string",
            "description": "it can one of following formats: (1) the number of pills to give (2) \"all\" if want to give all the medicine (3) weight such as 10mg.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that I have given the medicine to the person."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class CheckDosage(VirtualFunctionTool):
    name = "CheckDosage"
    summary = "Check the dosage of a given medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine",
            "type": "string",
            "description": "The name of the medicine whose dosage we want to check.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "dosage",
            "type": "string",
            "description": "The dosage of the medicine, which is usually written on the bottle."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class CheckMedicineExpirationDate(VirtualFunctionTool):
    name = "CheckMedicineExpirationDate"
    summary = "Check the expiration date of a given medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine",
            "type": "string",
            "description": "The medicine whose expiration date we want to check upon.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
...
class DisposeMedicine(VirtualFunctionTool):
    name = "DisposeMedicine"
    summary = "Dispose and throw away the medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine",
            "type": "string",
            "description": "The medicine that needs to be disposed.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the medicine is disposed."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class GrabMedicine(VirtualFunctionTool):
    name = "GrabMedicine"
    summary = "Grab a medicine."
    parameters: List[ArgParameter] = [
        {
            "name": "medicine",
            "type": "string",
            "description": "The name of the medicine that we need to fine.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "output",
            "type": "string",
            "description": "The description that the medicine was grabbed."
        }
    ]
    exceptions: List[ArgException] = [
        {
...
class CheckBodyCondition(VirtualFunctionTool):
    name = "CheckBodyCondition"
    summary = "Check whether a user has certain body condition such as allergy, drinking, food eaten recently, etc."
    parameters: List[ArgParameter] = [
        {
            "name": "person_name",
            "type": "string",
            "description": "The name of the person whose body condition we want to check upon.",
            "required": True
        },
        {
            "name": "specific_condition",
            "type": "string",
            "description": "A specific boolean condition that we want to know whether certain person satisfies, can be a physical or medical-related condition, such as having fever, headache, etc; can also be a general condition, such as gender == male, age > 18, etc.",
            "required": True
        }
    ]
    returns: List[ArgReturn] = [
        {
            "name": "have_or_not",
            "type": "boolean",
            "description": "Whether the person has the body condition."
        }
    ]
    exceptions: List[ArgException] = [
        {
            "name": "NotFoundException",
            "description": "There is no such person under the current scenario."
        }
    ]


@register_toolkit()
class MedicineTools(FunctionToolkit):
    name_for_human = "Tools for medicine taking"
    description_for_human = "Available tools for completing medicine-related instructions."
    name_for_model = "MedicineTools"
    description_for_model = "Available tools for completing medicine-related instructions."
    tool_classes = [
        GiveMedicine,
        SearchMedicine,
        CheckDosage,
        CheckLabelTitle,
        CheckMedicineExpirationDate,
        CheckBodyCondition,
        DisposeMedicine,
        CheckPersonalMedicationInteraction, 
